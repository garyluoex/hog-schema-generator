...
import com.gqlolap.hog.adapter.yaml.YamlInputAdapter;
import java.io.File;
...
public class OlapSchemaGeneratorTest {
  ...
  public void setUp() throws Exception {
    ...
    this.datasourceFile = Collections
  ...
  public void test() {
    ...
    YamlInputAdapter yamlInputAdapter = new YamlInputAdapter(datasourceFile, dimensionFiles,
        metricFile);
