...
public class WhereOperationProcessor implements Processor {
   ...
   * TODO.
   *
   * @param sourceDefinition TODO
   * @param typeDefinitionRegistry TODO
   * @return TODO
   */
  ...
  private List<InputValueDefinition> generateInputValueDefinition(
    ...
    Type operationType =
        typeDefinitionRegistry.isObjectType(sourceType)
            ? new TypeName(
            whereOperationInputDefinitionName(
                HelperMethods.serializeType(HelperMethods.innerMostType(sourceType))))
            : sourceType;
